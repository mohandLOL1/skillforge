...
public class UserService {
    ...
    public void registerUser(String role, String username, String email, String password) throws IOException { //only two users
        ...
        UserFactory factory = UserFactoryRegistry.getFactory(role.toLowerCase());
        ...
        User user = factory.createUser(username, email, hashedPassword);

        
        while (containsUser(user.getID())) {
            user = factory.createUser(username, email, hashedPassword);
        }
